#
#  Be sure to run `pod spec lint SlimEAS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SlimEAS"
  s.version      = "0.0.1"
  s.summary      = "Slim EAS Client"

  s.description  = <<-DESC
                   A Microsoft's EAS Client build by Slim. use for libslimCore
                   DESC

  s.homepage     = "https://github.com/en2de/Slim-EAS"
  ...
  #s.source       = { :git => "https://github.com/en2de/Slim-EAS.git", :tag => "0.0.1" }
  s.source        = { :git => "https://github.com/en2de/Slim-EAS.git" }
